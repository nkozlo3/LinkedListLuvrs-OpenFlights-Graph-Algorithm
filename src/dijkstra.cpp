...
std::unordered_map<std::string, double> Dijkstras::dijkstra(Graph graph, std::string startVertex)
{ // getedges = returns edge between two nodes
    ...
    std::unordered_map<std::string, std::unordered_map<std::string, Graph::pairOfAirports>> adjmap = graph.getAdjacanceMatrix();
    ...
    while (!priorityQ.empty())
    {
        ...
        std::unordered_map<std::string, Graph::pairOfAirports> adj = adjmap[curr];
